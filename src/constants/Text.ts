...
// English
export const homeEng = 'Home';
export const technologyEng = 'Technology';
export const arrayBiographyEng = 'Array Biography';
...
export const arrayBiographyRu = 'Масив, Биография';
...
export const arrayBiographyUa = 'Масив, Біографія';
...
//  english
export const buttonTextEng = 'Button';
export const creatorNameEng = 'Created by Aleksandr Sekker';
//  russian
export const buttonTextRu = 'Кнопка';
export const creatorNameRu = 'Александр Секкер';
//  ukrainian
...
//      Pomodoro app
//      english
export const startEng = 'Start';
export const finishEng = 'Stop';
export const placeholderLanguageEng = 'What are you working on?';
export const amountLanguageEng = 'Est Pomodoros';
export const addNotesLanguageEng = '+ Add notes';
export const notesPlaceholderLanguageEng = 'Some notes...';
export const cancelLanguageEng = 'Cancel';
export const saveLanguageEng = 'Save';
//  russian
export const startRu = 'Запустить';
export const finishRu = 'Стоп';
export const placeholderLanguageRu = 'Над чем ты работаешь?';
export const amountLanguageRu = 'Количество Помадоро';
export const addNotesLanguageRu = '+ Добавить заметки';
export const notesPlaceholderLanguageRu = 'Некоторые заметки...';
export const cancelLanguageRu = 'Отмена';
export const saveLanguageRu = 'Сохранить';
// ukrainian
export const startUa = 'Запустити';
export const finishUa = 'Стоп';
export const placeholderLanguageUa = 'Над чим ви працюєте?';
export const amountLanguageUa = 'Кількість Помадоро';
export const addNotesLanguageUa = '+ Додати нотатки';
export const notesPlaceholderLanguageUa = 'Деякі нотатки...';
export const cancelLanguageUa = 'Скасувати';
export const saveLanguageUa = 'Зберегти';
